    ...
    <div className="w-full bg-white border-b-2 rounded-bl-xl rounded-br-xl shadow shadow-gray-200">
      <div className="flex justify-end px-4 pt-4">
        <button
          ...
          className="inline-block text-gray-500 dark:text-gray-400 hover:bg-gray-100 focus:ring-2 focus:outline-none focus:ring-gray-100 dark:focus:ring-gray-300 rounded-lg text-sm p-1.5"
          type="button"
        >
